...
@Autonomous
@Config
public class attempt1coneauto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence b_sequence = drive.trajectorySequenceBuilder(initialPosition)
                .forward(62)
                ...
                .forward(4)
                .build();
        drive.followTrajectorySequenceAsync(b_sequence);
